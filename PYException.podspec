#
#  Be sure to run `pod spec lint PYException.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   PYException,Help developers reduce crash,example arr dic..and so on
                   DESC

  s.homepage     = "https://github.com/puyangdev/PYException"
  ...
  s.source       = { :git => "https://github.com/puyangdev/PYException.git", :tag => "#{s.version}" }
...
#      spec.dependency 'PYException/Global'
  ...
  s.subspec 'Header' do |spec|
      ...
      spec.source_files = "PYException/PYExceptionHeader.h"
  end
